# JS高级Day03![](http://www.yztcedu.com/images/logo.png)

# 原型

编程语言对面向对象的实现主流的有两种方式：基于**类**的面向对象和基于**原型**的面向对象。
...
大家知道，我们去访问一个对象的属性的时候，这个属性既有可能来自对象本身，也有可能来自这个对象的[[prototype]]属性指向的原型。
